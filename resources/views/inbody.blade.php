                    ...
                    <div class="bread-crumb text-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">اجهزة inbody</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="blog-sidebar mt-sm-60">
                        <div class="widget widget-search mb60">
                            ...
                            <div class="search-from">
                                <form action="{{ route('inbody') }}" method="GET">
                                    <input type="search" name="search" placeholder="ابحث عن جهاز أو مكان..." value="{{ request('search') }}">

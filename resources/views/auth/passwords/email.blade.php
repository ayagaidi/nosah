...
@section('content')
    <form method="POST" class="frm-single" action="{{ route('forgot-password.post') }}" style="max-width: 600px;">
        @csrf
    <div class="inside">
        <div class="title"><img src="{{asset('logo.png')}}" alt="" style="max-width: 40% !important;"></div>
        ...
        <!-- /.clearfix -->
        <button type="submit" class="frm-submit">إرسال كلمة مرور جديدة بالواتس اب <i class="fa fa-arrow-circle-right"></i></button>
       <!-- /.frm-input -->

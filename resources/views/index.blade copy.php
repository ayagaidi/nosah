...
@section('content')
   ...
   Watch Video <i class="fas fa-play"></i>
                ...
                <div class="col-lg-6 text-lg-right">
                    <div class="hero-soft2" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine"
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="heading" data-aos="fade-l  eft" data-aos-offset="300" data-aos-easing="ease-in-sine"
                        data-aos-duration="500" data-aos-delay="500">
                        <h2>{{ $home->clinics_title }}</h2>
                        <p>
                            {{ \Illuminate\Support\Str::limit($home->clinics_text) }}
                        </p>
                    </div>
                ...
                <div class="col-lg-6 d-lg-none">
                    <div class="feature-img" data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="heading" data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine">
                        <h2>{{ $home->inbody_title }}</h2>
                        <p>
                            {{ \Illuminate\Support\Str::limit($home->inbody_text) }}
                        </p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="blog-content">
                    ...
                    <a href="{{ route('article.show', $artical->id) }}"></a>
                          @endif
                      </p>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        videoLinks.forEach(link => {
            link.addEventListener('click', function () {
                ...
                // Convert to embeddable if it's YouTube

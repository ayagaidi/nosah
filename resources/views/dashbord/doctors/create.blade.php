...
<div class="row small-spacing">
    <div class="col-md-12">
        <div class="box-content">
            <h4 class="box-title"><a href="{{ route('doctorss') }}">الأطباء</a>/إضافة طبيب</h4>
        </div>
    </div>
    <div class="col-md-12">
        <div class="box-content">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="fullname" class="form-control @error('fullname') is-invalid @enderror" value="{{ old('fullname') }}" placeholder="اسم الطبيب">
                            @error('fullname')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="اسم المستخدم">
                            @error('username')
                            <span class="invalid-feedback" style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="phonenumber" maxlength="10" class="form-control @error('phonenumber') is-invalid @enderror" value="{{ old('phonenumber') }}" placeholder="رقم الهاتف">
                            @error('phonenumber')
                            <span class="invalid-feedback" style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select name="specializations_id" class="form-control @error('specializations_id') is-invalid @enderror">
                        ...
                        @foreach($specializations as $specialization)
                            <option value="{{ $specialization->id }}" {{ old('specializations_id') == $specialization->id ? 'selected' : '' }}>
                                {{ $specialization->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <!-- إضافة حقل السيرة الذاتية -->
                <div class="form-group">
                    <label for="cv" class="control-label">السيرة الذاتية (PDF أو DOC)</label>
                ...
                <div class="form-group text-center">
                    <button type="submit" class="btn btn-primary waves-effect waves-light">إضافة طبيب</button>
                </div>
            </form>
        </div>
    </div>
